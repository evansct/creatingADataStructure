...
//		System.out.println(test.lookupPopularity(2));
	...
	public void test11() {
		...
		test.addString(2, "DDD");
		System.out.println(test.lookupPopularity(0));
		System.out.println(test.lookupPopularity(1));
		System.out.println(test.lookupPopularity(2));
		System.out.println(test.lookupPopularity(3));
		assertEquals("AAA", test.lookupPopularity(2));
		assertEquals("BBB", test.lookupPopularity(0));
		assertEquals("CCC", test.lookupPopularity(3));
		assertEquals("DDD", test.lookupPopularity(1));
	}
